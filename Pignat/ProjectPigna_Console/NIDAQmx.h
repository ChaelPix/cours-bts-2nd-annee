...
#define DAQmx_Exported_PauseTrig_Lvl_ActiveLvl                           0x1616 // Specifies the polarity of the exported Pause Trigger.
...
#define DAQmx_SampClk_TimingResponseMode                                 0x2965 // Specifies how the device responds to the sample clock and to triggers.
...
//*** Values for DAQmx_SampClk_TimingResponseMode ***
